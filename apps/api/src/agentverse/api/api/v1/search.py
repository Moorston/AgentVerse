...
from agentverse.api.core.dependencies import get_repository, get_graphrag_engine
...
async def search(
    ...
    try:
        ...
        return await _fallback_search(q, top_k)


async def _fallback_search(q: str, top_k: int) -> SearchResponse:
